                ...
                <div className="container">
                    <div className="section-top-border">
                        ...
                        <div className="row">
                            <div className="col-md-3">
                                <img src="img/d.jpg" alt="" className="img-fluid" />
                            </div>
                    ...
                    <div className="section-top-border">
                        ...
                        <div className="row gallery-item">
                            <div className="col-md-4">
                                <a href="img/g1.jpg" className="img-pop-up"><div className="single-gallery-image" style="background: url(img/g1.jpg);"></div></a>
                            </div>
                            <div className="col-md-4">
                                <a href="img/g2.jpg" className="img-pop-up"><div className="single-gallery-image" style="background: url(img/g2.jpg);"></div></a>
                            </div>
                            <div className="col-md-4">
                                <a href="img/g3.jpg" className="img-pop-up"><div className="single-gallery-image" style="background: url(img/g3.jpg);"></div></a>
                            </div>
                            <div className="col-md-6">
                                <a href="img/g4.jpg" className="img-pop-up"><div className="single-gallery-image" style="background: url(img/g4.jpg);"></div></a>
                            </div>
                            <div className="col-md-6">
                                <a href="img/g5.jpg" className="img-pop-up"><div className="single-gallery-image" style="background: url(img/g5.jpg);"></div></a>
                            </div>
                            <div className="col-md-4">
                                <a href="img/g6.jpg" className="img-pop-up"><div className="single-gallery-image" style="background: url(img/g6.jpg);"></div></a>
                            </div>
                            <div className="col-md-4">
                                <a href="img/g7.jpg" className="img-pop-up"><div className="single-gallery-image" style="background: url(img/g7.jpg);"></div></a>
                            </div>
                            <div className="col-md-4">
                                <a href="img/g8.jpg" className="img-pop-up"><div className="single-gallery-image" style="background: url(img/g8.jpg);"></div></a>
                            </div>
                        </div>
                    </div>
                    <div className="section-top-border">
